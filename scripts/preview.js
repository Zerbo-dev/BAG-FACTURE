...
const sampleData = {
  ...
  client: {
    name: "M. Sawadogo",
    address: "1 Kamboinsin, Ouaga, BF",
    phone: "+226 70245268",
  },
  items: [
    { description: "Diagnostic et repérage", unitPrice: 25000, quantity: null },
    { description: "Câblage du tableau électrique", unitPrice: 55000, quantity: null },
  ],
  tvaRate: 0,
};
...
main().catch((err) => {
  ...
  console.error(
    "\nSi l'erreur vient de Chromium (ex: 'wrong ELF class' ou 'exec format error'),\n" +
      ...
      "fonctionnera normalement une fois deploye sur Vercel (environnement Linux)."
  );
  process.exit(1);
});
